...
function init() : void {
	...
	bcs.$B0 = new Instruction_branch_conditional(() => flags.C);
	beq.$F0 = new Instruction_branch_conditional(() => flags.Z);
	bmi.$30 = new Instruction_branch_conditional(() => flags.N);
	...
	bvs.$70 = new Instruction_branch_conditional(() => flags.V);
}
